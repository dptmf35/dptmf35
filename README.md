...
## 👩🏻‍🦱 안녕하세요, AI Robotics Engineer 정예슬입니다.

**WHO AM I?**  
인공지능과 로봇, 데이터 활용에 관심이 많아요.  
...
&nbsp
<img src="https://img.shields.io/badge/vLLM-000000?style=flat-square&logo=OpenAI&logoColor=white"/></a>&nbsp
</p>
...
- **AI Model Development**: LLM Fine-tuning, Image/Text Classification, Object Detection & Tracking
- **Data Engineering**: Multi-modal 데이터 처리 (LiDAR, Camera, Sensor Fusion), 학습 데이터 자동화 파이프라인 구축 
- **Robot Simulation**: Isaac Sim 환경 구축, ROS2 연동, 모바일 로봇/매니퓰레이터 실험
- **Algorithm Optimization**: 경량화 모델 개발, 실시간 배포 환경 최적화
